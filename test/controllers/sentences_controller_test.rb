...
class SentencesControllerTest < ActionController::TestCase
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post :create, sentence: { sentence: @sentence.sentence, user_id: @sentence.user_id, word_id: @sentence.word_id }
    end
  ...
  test "should update sentence" do
    patch :update, id: @sentence, sentence: { sentence: @sentence.sentence, user_id: @sentence.user_id, word_id: @sentence.word_id }
    assert_redirected_to sentence_path(assigns(:sentence))
  end
